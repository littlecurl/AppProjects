...
public class Main {
    //获取数据库连接对象
    static MongoDatabase db = MongoDBUtil.getConnect();
    //获取集合
    static MongoCollection<Document> table = db.getCollection("comment");
    ...
    public static void main(String[] args) {
        ...
        // 获得新闻列表
        List<NewsList> newsList = getNewsListFromUrl(mUrl);
        ...
        for (News newsDetail : newsDetailList) {
            ...
            for (String commentJsonUrl : commentJsonUrlList) {
                ...
                if (!documentList.isEmpty()){
                    ...
                    System.out.println("插入失败，list为空。正在获取下一篇文章评论......");
                }
            }
        }
        ...
        System.out.println("获取前"+newsCount+"篇新闻评论并插入MongoDB数据库" +
