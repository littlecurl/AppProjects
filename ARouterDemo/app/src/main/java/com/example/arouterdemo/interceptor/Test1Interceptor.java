package com.example.arouterdemo.interceptor;
...
import com.example.arouterdemo.util.MainLooper;
...
public class Test1Interceptor implements IInterceptor {
    ...
    public void process(final Postcard postcard, final InterceptorCallback callback) {
        if (MyRouter.ACTIVITY_URL_TARGET_INTERCEPTOR.equals(postcard.getPath())) {
