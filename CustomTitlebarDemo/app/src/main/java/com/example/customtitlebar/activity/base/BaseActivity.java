package com.example.customtitlebar.activity.base;
...
import com.example.customtitlebar.TransitionHelper;

public abstract class BaseActivity extends AppCompatActivity {

    protected ActivityOptionsCompat getActivityOptionsCompat(Activity activity) {
